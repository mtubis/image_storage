...
return Application::configure(basePath: dirname(__DIR__))
    // A JSON API only: no web routes (the frontend is a separate app).
    ->withRouting(
        api: __DIR__.'/../routes/api.php',
        commands: __DIR__.'/../routes/console.php',
        health: '/up',
    )
    // Installs Laravel's default global middleware, groups and aliases; without the call the
    // kernel has none, not even the "api" group.
    ->withMiddleware()
