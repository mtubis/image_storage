...
final class ImageController extends Controller
{
    ...
    #[Endpoint(
        ...
        description: 'Stores the file with its EXIF/IPTC metadata and a WebP thumbnail. A truncated or otherwise damaged file is rejected with a `422`. `temperature_c` is `null` in the response: it is fetched afterwards.',
    )]
